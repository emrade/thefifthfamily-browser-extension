...
export const PAGE_FEATURE_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      'A small icon at the top-right of the page (on 24 pages so far) showing only the achievement lines relevant to that page — current tier, progress to the next one, and a Claim button the moment a line is ready. Click it to open.',
  },
  {
    id: 'garageBulkOps',
